...
import com.timepicker.ChangeDatePopwindow;
import com.timepicker.ChangeDatePopwindow2;
...
public class TimerPickerDemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new
                        DatePickerDialog(TimerPickerDemoActivity.this, new DatePickerDialog.OnDateSetListener() {
                            @Override
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog dialog = new TimePickerDialog(TimerPickerDemoActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerView pvTime = new TimePickerView.Builder(TimerPickerDemoActivity.this, new TimePickerView.OnTimeSelectListener() {
                    @Override
...
//                        .isDialog(true)//是否显示为对话框样式
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OptionsPickerView pvOptions = new  OptionsPickerView.Builder(TimerPickerDemoActivity.this, new OptionsPickerView.OnOptionsSelectListener() {
                    @Override
...
//                        .isDialog(true)//是否显示为对话框样式
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ChangeDatePopwindow mChangeBirthDialog = new ChangeDatePopwindow(TimerPickerDemoActivity.this);
                ...
                mChangeBirthDialog.setBirthdayListener(new ChangeDatePopwindow.OnBirthListener() {
                    ...
                    public void onClick(String year, String month, String day) {
                        ...
                        Toast.makeText(TimerPickerDemoActivity.this,year + "-" + month + "-" + day, Toast.LENGTH_LONG).show();
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] str = new String[10];
                final ChangeDatePopwindow2 mChangeBirthDialog = new ChangeDatePopwindow2(TimerPickerDemoActivity.this);
                mChangeBirthDialog.setDate("2017", "6", "20");
                mChangeBirthDialog.showAtLocation(main, Gravity.BOTTOM, 0, 0);
